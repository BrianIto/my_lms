...
Use the Better Auth best-practices skill guidance. The service must be TypeScript-first and easy to connect to a PostgreSQL service via `.env`.
...
8. Keep code framework-agnostic enough to run as a separate auth microservice.
