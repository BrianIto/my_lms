...
function AdminView() {
	...
	return (
		<LmsShell
			...
			description="Check metrics, manage beta allowlist, and author courses."
		>
			...
			<div className="grid lg:grid-cols-[1.08fr_0.92fr]">
				<Card className="border-white/15 bg-background z-[99] lg:border-r-0 shadow-[inset_0_0_24px_rgba(255,186,90,0.03)]">
					<CardHeader>
			...
			<Card className="border-white/15 bg-background/85 z-[99]">
				<CardHeader>
					<CardTitle className="font-display text-3xl tracking-tighter text-white">
						Course inventory
					</CardTitle>
